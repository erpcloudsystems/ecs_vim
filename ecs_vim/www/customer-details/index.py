...
def prepare_input_values(context, user):
    ...
    for row in customer.customer_family_detail:
        if row.relation not in ["Daughter", "Son", "self"]:
            adults_count +=1
        else:
                    ...
                    <table border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        ...
                        """ + f"""
                          ...
                          <a href="https://erp.vim.sa/verify-email/" target="_blank" style="display: inline-block; padding: 16px 36px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; color: #ffffff; text-decoration: none; border-radius: 6px;">Do Something Sweet</a>
                        """ + """
...
def create_coupon_code(custom_first_login, customer, context):
    if not custom_first_login:
        r = verify_account()
        customer.custom_first_login =1
