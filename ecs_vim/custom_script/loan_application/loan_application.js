frappe.ui.form.on("Loan Application", {
	...
	existing_loan: function(frm) {
		...
		frappe.call({
			method: 'ecs_vim.custom_script.loan_application.loan_application.get_balance_loan',
			args: {
	...
	eos_amt: function(frm) {
		...
		frappe.call({
			method: 'ecs_vim.custom_script.loan_application.loan_application.eos_amount',
			args: {
				applicant: frm.doc.applicant,
