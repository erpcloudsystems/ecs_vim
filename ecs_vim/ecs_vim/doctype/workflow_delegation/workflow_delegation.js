...
frappe.ui.form.on('Workflow Delegation', {
   ...
   onload:function(frm)
   {
       ...
       {
           frappe.call({
               method:"ecs_vim.ecs_vim.doctype.workflow_delegation.workflow_delegation.get_user_role",
   ...
   setup:function(frm)
   {
       cur_frm.set_query("user_role", "workflow_delegation_details", function(doc, cdt, cdn) {
           ...
           return {
               query: "ecs_vim.ecs_vim.doctype.workflow_delegation.workflow_delegation.get_element",  
               filters: {
   ...
   {
       frappe.call({
           method:"ecs_vim.ecs_vim.doctype.workflow_delegation.workflow_delegation.assign_delegated_role",
           args:{},
           callback:function(r)
           {
