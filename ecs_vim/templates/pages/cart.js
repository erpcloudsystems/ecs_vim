...
$.extend(shopping_cart, {
		...
		return frappe.call({
			...
			callback: function(r) {
				...
				if(r.exc) {
					...
					$(btn).hide();
					window.location.href = '/app/sales-order/' + encodeURIComponent(r.message);
				}
			}
		});
	},
	...
	bind_coupon_code: function() {
        ...
        // }
        //     frappe.call({               
        //         method: "vim.custom_script.point_of_sale.point_of_sale.validate_coupen_item",
        //         args : {
        //             items:items,
	...
	apply_coupon_code: function(btn) {
        ...
        for (var i = 0; i < elts.length; ++i) {
            ...
            frappe.call({               
                method: "ecs_vim.doctype_triggers.point_of_sale.point_of_sale.validate_coupen_item",
                args : {
                    items:items,
                    applied_code :  $('.txtcoupon').val().toUpperCase()
