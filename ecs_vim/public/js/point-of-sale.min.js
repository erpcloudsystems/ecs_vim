    ...
    (erpnext.PointOfSale.ItemSelector = class {
        ...
        get_items(t) {
            ...
            if ((!s && (s = this.parent_item_group), o)){
                var result =  frappe.call({ method: "ecs_vim.doctype_triggers.point_of_sale.point_of_sale.get_pos_items", freeze: !0, args: { start: e, page_length: i, price_list: o, item_group: s, search_value: a, pos_profile: r } });
            ...
            render_payment_mode_dom() {
                ...
                this.$payment_modes.html(`${
                    payments.map((p, i) => {
                        ...
                        const amount = format_currency(p.amount, currency,2);
        ...
        (erpnext.PointOfSale.Controller = class {
            ...
            create_closing_voucher() {
                var t,
                    ...
                    a = new frappe.ui.Dialog({
                        ...
                        static: !0,
                        fields: [{ fieldname: "closing_details", fieldtype: "Table", label: "Closing Details", cannot_add_rows: 0, in_place_edit: 1, reqd: 1, data: [], fields: i }],
                        primary_action: async function (t) {
                            ...
                            (n.pos_profile = e.frm.doc.pos_profile),
                                ...
                                (n.cash_closing_amont = i.find(el => el.mode_of_payment.toLowerCase().includes('cash')) ? i.find(el => el.mode_of_payment.toLowerCase().includes('cash')).closing_amount : 0),
                                (n.custom_credit_closing_amont = i.find(el => el.mode_of_payment.toLowerCase().includes('credit')) ? i.find(el => el.mode_of_payment.toLowerCase().includes('credit')).closing_amount : 0),
                                (n.custom_bank_transfer_closing_amont = i.find(el => el.mode_of_payment.toLowerCase().includes('bank')) ? i.find(el => el.mode_of_payment.toLowerCase().includes('bank')).closing_amount : 0),
                    ...
                    frappe.db.get_doc("POS Profile", t).then(function (t) {
                        ...
                        (a.fields_dict.closing_details.df.data = []),
                            e.forEach(function (t) {
                                ...
                                frappe.db.get_value("Mode of Payment", e, ["type", "name"]).then(function (t) {
                                    var i = t.message;
                                    ("Cash" == String(i.type) || String(i.name).toLowerCase().includes("credit")) &&
                                            ...
                                            (i.fields_dict.balance_details.df.data = []),
                                                e.forEach(function (t) {
                                                    ...
                                                    frappe.db.get_value("Mode of Payment", e, "type").then(function (t) {
                                                        var a = t.message;
                                                        ("Cash" == String(a.type) || String(a.name).toLowerCase().includes("credit")) &&
            ...
            async check_stock_availability(item_row, qty_needed, warehouse) {
                ...
                if (!warehouse){
                    ...
                    warehouse = await frappe.db.get_value("POS Profile",  this.frm.doc.pos_profile, "warehouse");
                    warehouse = warehouse.message.warehouse
                }
                console.log(warehouse)
                ...
                const bold_available_qty = available_qty[0].toString().bold()
                ...
                } else if (available_qty[0] < qty_needed) {
                    frappe.model.clear_doc(item_row.doctype, item_row.name);
            ...
            get_none_consalidated_invoices(item_code, warehouse) {
                
                return frappe.call({
                    method: "ecs_vim.api.get_none_consalidated_invoices",
